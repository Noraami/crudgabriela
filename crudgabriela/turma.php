            ...
            <div class="">
                ...
                foreach ($turmas as $linha) {
                    echo '<tr>
                            ...
                            <td> <a href="listar_atividades_turma.php?codigo=' . $linha['pk_turma'] . '"> <button class="btnturma">Atividades</button> </a> </td>
                            <td> <a href="excluir_turma.php?codigo=' . $linha['pk_turma'] . '"> <button class="btnturma">Excluir</button> </a> </td>
